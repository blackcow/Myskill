...
source_url: "https://help.obsidian.md/web-clipper/variables"
final_url: "https://obsidian.md/help/web-clipper/variables"
canonical_url: "https://obsidian.md/help/web-clipper/variables"
...
word_count: 1378
content_chars: 9318
content_sha256: "89a5e55a4f41749bb0bf0ccb709f226b14b596f4991b6e8d99f820373d83e7e5"
asset_count: 0
status: "raw"
---
...
- [Preset variables](https://obsidian.md/help/web-clipper/variables#Preset variables)
- [Prompt variables](https://obsidian.md/help/web-clipper/variables#Prompt variables)
- [Meta variables](https://obsidian.md/help/web-clipper/variables#Meta variables)
- [Selector variables](https://obsidian.md/help/web-clipper/variables#Selector variables)
- [Schema.org variables](https://obsidian.md/help/web-clipper/variables#Schema.org variables)
...
- `{{selectorHtml:body|markdown}}` returns the entire HTML of the `body` element, converted to Markdown using the `markdown` [filter](https://obsidian.md/help/web-clipper/filters#HTML processing).
- Nested CSS selectors and combinators are supported if you need more specificity.
- If multiple elements match the selector, an array is returned, which you can process with [array and object filters](https://obsidian.md/help/web-clipper/filters#Arrays and objects) like `join` or `map`.
...
Schema variables allow you to extract data from [schema.org](https://schema.org/) JSON-LD on the page. Schema.org data can also be used to automatically [trigger a template](https://obsidian.md/help/web-clipper/templates#Schema.org matching).
